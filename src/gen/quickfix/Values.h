...
namespace FIX
{
 ...
 const char SecurityType_TAX_AND_REVENUE_ANTICIPATION_NOTE[] = "TRAN";
 ...
 const char StipulationType_AUTO_REINVESTMENT_AT_OR_BETTER[] = "AUTOREINV";
 ...
 const char StipulationType_GEOGRAPHICS_AND_PERCENT_RANGE[] = "GEOG";
 ...
 const char StipulationValue_SPECIAL_CUM_DIVIDEND[] = "CD";
 const char StipulationValue_SPECIAL_EX_DIVIDEND[] = "XD";
 const char StipulationValue_SPECIAL_CUM_COUPON[] = "CC";
 const char StipulationValue_SPECIAL_EX_COUPON[] = "XC";
 const char StipulationValue_SPECIAL_CUM_BONUS[] = "CB";
 const char StipulationValue_SPECIAL_EX_BONUS[] = "XB";
 const char StipulationValue_SPECIAL_CUM_RIGHTS[] = "CR";
 const char StipulationValue_SPECIAL_EX_RIGHTS[] = "XR";
 const char StipulationValue_SPECIAL_CUM_CAPITAL_REPAYMENTS[] = "CP";
 const char StipulationValue_SPECIAL_EX_CAPITAL_REPAYMENTS[] = "XP";
 const char StipulationValue_CASH_SETTLEMENT[] = "CS";
 const char StipulationValue_SPECIAL_PRICE[] = "SP";
 const char StipulationValue_REPORT_FOR_EUROPEAN_EQUITY_MARKET_SECURITIES[] = "TR";
 const char StipulationValue_GUARANTEED_DELIVERY[] = "GD";
 ...
 const char ClearingFeeIndicator_FIRMS_106H_AND_106J[] = "H";
